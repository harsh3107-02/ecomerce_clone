...
function Home() {
  return (<div><ImageSlider slides={SliderData} />
  ...
  <Product
    ...
    <div className="credit">
      ...
      <img src="https://images-eu.ssl-images-amazon.com/images/G/31/img19/AmazonPay/Boson/Sid/CCBP/DesktopGateway_CategoryCard_379x304_CCBP._SY304_CB413372299_.jpg" className='ok1' alt="" />
      <a href=''>Pay now</a>
    </div>
    </div>
    <Onebox/>
